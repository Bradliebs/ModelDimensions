...
class QueryRequest(BaseModel):
    ...
    rerank: Optional[bool] = None  # None = use service default (on if reranker configured)
    candidate_pool: Optional[int] = Field(default=None, ge=1, le=500)
    rerank_min_score: Optional[float] = Field(default=None, ge=0.0, le=1.0)  # None = service default
