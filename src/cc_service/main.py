...
Environment variables:
    ...
    CCMEM_RERANKER     cross-encoder model for stage-2 reranking (default: none)
    CCMEM_RERANK_MIN_SCORE  drop rerank hits below this score, [0,1] (default: 0.10)
"""
...
async def lifespan(app: FastAPI):
    ...
    reranker = os.environ.get("CCMEM_RERANKER") or None
