...
- Copilot Studio builds custom agents (formerly called copilots) that combine
  topics, generative answers, and actions over enterprise data.
...
- Actions let an agent call connectors, Power Automate flows, or REST APIs to
  take real work beyond answering questions.
